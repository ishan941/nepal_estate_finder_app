...
import 'package:provider_with_clean_architecture/features/resturent/data/model/resturent_model.dart';

abstract class ResturentDataSource {
  Future<bool> saveResturent({required Map queryData,});
  Future<List<ResturentModel>> getResturent();
  Future<bool> deleteResturent({required String id});
  Future<bool> editResturent({required Map<String, dynamic> queryData, required String id});
}
...
@override
  Future<bool> editResturent({required Map<String, dynamic> queryData, required String id}) async {
