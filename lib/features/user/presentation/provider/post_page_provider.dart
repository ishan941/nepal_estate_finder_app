...
import 'package:provider_with_clean_architecture/features/user/data/model/post_model.dart';
...
numberOfSeats: numberOfSeats
  ...
  Either<Failure, bool> response = await postUseCase(PostParams(queryData: postModel.toJson()));
