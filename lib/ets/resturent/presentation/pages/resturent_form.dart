...
class ResturentForm extends StatefulWidget {
  final ResturentResponseEntity? resturentResponseEntity;

  const ResturentForm({Key? key, this.resturentResponseEntity})
      : super(key: key);
...
class _ResturentFormState extends State<ResturentForm> {
